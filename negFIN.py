...
# def run_negfin_on_all_files(data_folder, output_folder, min_support, delimiter=' '):
#     # Iterate over all files in the data folder
#     for filename in os.listdir(data_folder):
#         if filename.endswith('.dat'):
#             dataset_file = os.path.join(data_folder, filename)
...
# # Define the path to the folder containing your data files and the output folder
# data_folder = './data'
...
# # Run NegFIN on all .dat files in the data folder
